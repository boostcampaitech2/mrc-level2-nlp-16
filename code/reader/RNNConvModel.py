...
class RNNConvModel(nn.Module):
    def __init__(
        ...
        self.conv_layer_1 = nn.Conv1d(512 * 2, 1024, kernel_size=1, padding=0)
        self.conv_layer_3 = nn.Conv1d(512 * 2, 1024, kernel_size=3, padding=1)
        self.conv_layer_5 = nn.Conv1d(512 * 2, 1024, kernel_size=5, padding=2)
